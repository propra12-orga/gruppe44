...
import de.bomberman.timer.AllowBombTimer;
	 ...
	 *
	 */
public class PlayerTwoKeyListenerServer extends PlayerTwoKeyListener implements KeyListener{
	...
	public void keyPressed(KeyEvent arg0) {
		if(BombermanMain.getPlayerCnt() > 1 && this.isAlive() && !BombermanMain.getPlayers()[1].isDead()) {
	...
	private void say(int i) {
		...
		/*if( true) {
			...
			BombermanClient.submit(1, i, xPos, yPos, 0);
		}*/
	}
	...
	public static void setDelay(int delay) {
		PlayerTwoKeyListenerServer.delay = delay;
	}
	...
	public static void setBombDelay(int bombDelay) {
		PlayerTwoKeyListenerServer.bombDelay = bombDelay;
	}
